			...
			app.Div().Class("container").Body(
				app.Div().Class("row").Body(
					app.Div().Class("text-content").Body(
						...
						app.P().Text("Hol dir bessere Noten mit unserer Lern-App StudyBear."),
